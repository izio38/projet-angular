      ...
      this.heroForm = new FormGroup(
        {
          ...
          agility: new FormControl(this.hero.abilities.agility, [
            Validators.min(1),
            Validators.max(40),
          ]),
          attack: new FormControl(this.hero.abilities.attack, [
            Validators.min(1),
            Validators.max(40),
          ]),
          health: new FormControl(this.hero.abilities.health, [
            Validators.min(1),
            Validators.max(40),
          ]),
          strength: new FormControl(this.hero.abilities.strength, [
            Validators.min(1),
            Validators.max(40),
          ]),
